...
function populateV0_0_1_CardCondition(db: Kysely<any>) {
  ...
  values.push({
    created_at: now, id: "MT", color_code: "", sequence: 0, expression: "Mint", condition: "Perfect", us_expression: "Mint", description:
  ...
  values.push({
    created_at: now, id: "NM", color_code: "", sequence: 1, expression: "Near Mint", condition: "Pack-Fresh", us_expression: "Near Mnt", description:
  ...
  values.push({
    created_at: now, id: "EX", color_code: "", sequence: 2, expression: "Excellent", condition: "Minor Wear", us_expression: "Slightly Played | Excellent", description:
  ...
  values.push({
    created_at: now, id: "GD", color_code: "", sequence: 3, expression: "Good", condition: "Visible Wear", us_expression: "Moderately Played | Very Good", description:
  ...
  values.push({
    created_at: now, id: "LP", color_code: "", sequence: 4, expression: "Light Played", condition: "Severe Wear", us_expression: "Played | Good", description:
  ...
  values.push({
    created_at: now, id: "PL", color_code: "", sequence: 5, expression: "Played", condition: "Damaged", us_expression: "Heavily Played", description:
  ...
  values.push({
    created_at: now, id: "PO", color_code: "", sequence: 6, expression: "Poor", condition: "Destroyed", us_expression: "Poort", description:
