...
export class IpcDispatcherService implements IIpcDispatcherService{
  ...
  public Initialize(): IIpcDispatcherService {
    ...
    ipcMain.handle("new-sync", (_event: Electron.IpcMainEvent, ...args: Array<any>) => container.resolve<IIpcSyncService>(INFRATOKENS.IpcSyncService).newHandle(args[0], this.windowService.mainWindow));
