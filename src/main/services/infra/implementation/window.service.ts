...
export class WindowService implements IWindowService {
  ...
  public constructor(@inject(INFRATOKENS.ConfigurationService) configurationService: ConfigurationService) {
  ...
  public async boot(bootFunction: (splashWindow: BrowserWindow) => Promise<void>): Promise<void> {
