...
import { ColorRouter, GameFormatRouter, LanguageRouter } from "./routers";
...
export class MasterDataDi {
  public static register() {
    ...
    container.register<IRouter>(INFRASTRUCTURE.Router, { useClass: GameFormatRouter }, { lifecycle: Lifecycle.Singleton });
