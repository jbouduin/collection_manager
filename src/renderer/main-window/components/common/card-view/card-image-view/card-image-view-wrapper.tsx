...
export function CardImageViewWrapper(props: CardImageViewWrapperProps) {
  ...
  function render(): React.JSX.Element {
    switch (props.card.cardLayout) {
      ...
      case "host":
      case "leveler":
      case "meld": // NEXT "Show back" as it can have a back
      case "mutate":
      case "normal":
      case "planar":
      case "prototype":
      ...
      case "split":
      case "token":
      case "vanguard": // NEXT "Show back" vanguard has "show back on scryfall", but it looks like a normal back"
        return (
          <CardImageView
            cardfaceSequence={0}
      ...
      case "art_series": // NEXT art series have reverse and need flip as there are horizontal and vertical cards solve by adding buttons
        return (
          <CardImageView
