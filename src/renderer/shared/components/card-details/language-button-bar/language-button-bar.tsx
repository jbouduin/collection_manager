...
import { ILanguageDto, IMtgCardLanguageDto } from "../../../../../common/dto";
...
export function LanguageButtonBar(props: LanguageButtonBarProps) {
  ...
  function onAnyButtonClick(language: IMtgCardLanguageDto): void {
    ...
    <LanguagesContext.Consumer >
      {
        (languages: Array<ILanguageDto>) => (
          <ButtonGroup className="language-button-bar" minimal={true}>
            {
              props.cardLanguages.map((language: IMtgCardLanguageDto) => {
                const languageDef = languages.find((lng: ILanguageDto) => lng.id == language.lang);
